...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Sat Sep 13 12:49:28 2014
# Project:  pacman.pro
# Template: app
...
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lglut -lGL -lGLU -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
Pacman.o: Pacman.cpp OpenGLHeaders.h \
		Renderer.cpp \
		Renderer.h \
		Direction.h \
		Timer.cpp \
